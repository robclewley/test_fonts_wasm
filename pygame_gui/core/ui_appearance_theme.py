...
# TEMP hack
print("TEMP hack in ui_appearance_theme to use local folder font file path reference")
        ...
        for element_key, locale_font_info in self.ui_element_fonts_info.items():
            for locale_key, font_info in locale_font_info.items():
                if 'regular_path' in font_info:
                    ...
                    # TEMP avoiding PackageResource
                    regular_resource: str = fonts_path(reg_res_data['package'],
                                                          reg_res_data['resource'])
                    ...
                    if 'bold_resource' in font_info:
                        ...
                        bold_resource = fonts_path(bold_res_data['package'],
                                                        bold_res_data['resource'])
                    ...
                    if 'italic_resource' in font_info:
                        ...
                        italic_resource = fonts_path(italic_res_data['package'],
                                                          italic_res_data['resource'])
                    ...
                    if 'bold_italic_resource' in font_info:
                        ...
                        bld_it_resource = fonts_path(bld_it_res_data['package'],
                                                          bld_it_res_data['resource'])
